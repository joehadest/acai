                ...
                >
                    ...
                    >
                        <span className="relative flex h-3 w-3">
                            <span className={`animate-ping absolute inline-flex h-full w-full rounded-full ${isOpen ? 'bg-purple-500' : 'bg-gray-500'} opacity-75`}></span>
                            <span className={`relative inline-flex rounded-full h-3 w-3 ${isOpen ? 'bg-purple-600' : 'bg-gray-600'}`}></span>
                        </span>
            ...
            {showInfo && (
                <AnimatePresence>
                    ...
                    >
                        ...
                        >
                            {/* Header do Modal */}
                            <div className="bg-gradient-to-r from-purple-600 to-purple-700 p-6 rounded-t-2xl relative overflow-hidden">
                                ...
                                <div className="relative z-10 flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-purple-100 text-sm">Informações do Restaurante</p>
                                        </div>
                                    </div>
                                    <motion.button
                                ...
                                <div className="bg-gray-800/30 rounded-xl p-4 border border-gray-700/50">
                                    ...
                                    <div className="space-y-2 text-sm">
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="text-purple-400 font-medium">Fechado</span>
                                        </div>
                                    </div>
                                </div>
