                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className={`grid grid-cols-${Object.keys(item.sizes).length > 2 ? 3 : 2} gap-3`}>
                                    {Object.entries(item.sizes).map(([sizeKey, price]) => (
                                        <button
                                            ...
                                            className={`p-3 rounded-lg border-2 transition-all ${selectedSize === sizeKey ? 'border-purple-600 bg-purple-900/20 text-purple-400' : 'border-gray-700 hover:border-purple-600 text-gray-300'}`}
                                        >
                        ...
                        {itemCategory?.allowHalfAndHalf && allPizzas && (
                            <div className={`p-4 rounded-lg transition-all duration-300 ${isHalf ? 'bg-gradient-to-r from-purple-900/30 to-purple-800/20 border-2 border-purple-600/50' : 'bg-[#1e1d1d] border border-gray-700'}`}>
                                <label className="flex items-center gap-3 mb-3 cursor-pointer group">
                                    <div className="relative">
                                        <input
                                            ...
                                            className="form-checkbox h-6 w-6 text-purple-600 bg-gray-800 border-gray-600 rounded focus:ring-purple-500 transition-all duration-200"
                                        />
                                        {isHalf && (
                                            <motion.div
                                                initial={{ scale: 0 }}
                                    ...
                                    <span className={`text-lg font-medium transition-colors duration-200 ${isHalf ? 'text-purple-400' : 'text-gray-200 group-hover:text-gray-300'}`}>
                                ...
                                <AnimatePresence>
                                    {isHalf && (
                                        ...
                                        >
                                            <div>
                                                <label className="block text-xs text-purple-300 mb-2 font-medium">1º Sabor</label>
                                                <select
                                                    className="w-full rounded-lg border-2 border-purple-600/50 bg-[#262525] text-white p-3 focus:border-purple-500 focus:ring-purple-500 transition-all duration-200"
                                                    value={half1?.name || ''}
                                                    onChange={e => {
                                            ...
                                            <div>
                                                <label className="block text-xs text-purple-300 mb-2 font-medium">2º Sabor</label>
                                                <select
                                                    className="w-full rounded-lg border-2 border-purple-600/50 bg-[#262525] text-white p-3 focus:border-purple-500 focus:ring-purple-500 transition-all duration-200"
                                                    value={half2?.name || ''}
                                                    onChange={e => {
                                            ...
                                            {half1 && half2 && (
                                                <motion.div
                                                    ...
                                                    className="col-span-full mt-2 p-3 bg-purple-900/20 border border-purple-600/30 rounded-lg"
                                                >
                            ...
                            <div className="bg-[#1e1d1d] p-4 rounded-lg">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <button
                                        ...
                                        className={`p-3 rounded-lg border-2 transition-all ${selectedBorder === '' ? 'border-purple-600 bg-purple-900/20 text-purple-400' : 'border-gray-700 hover:border-purple-600 text-gray-300'}`}
                                    >
                                    ...
                                    {Object.entries(item.borderOptions).map(([borderKey, price]) => (
                                        <button
                                            ...
                                            className={`p-3 rounded-lg border-2 transition-all ${selectedBorder === borderKey ? 'border-purple-600 bg-purple-900/20 text-purple-400' : 'border-gray-700 hover:border-purple-600 text-gray-300'}`}
                                        >
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {Object.entries(item.extraOptions).map(([extraKey, price]) => (
                                        <button
                                            ...
                                            className={`p-3 rounded-lg border-2 transition-all ${selectedExtras.includes(extraKey) ? 'border-purple-600 bg-purple-900/20 text-purple-400' : 'border-gray-700 hover:border-purple-600 text-gray-300'}`}
                                        >
                        ...
                        <div className="bg-[#1e1d1d] p-4 rounded-lg">
                            ...
                            <textarea
                                ...
                                className="w-full p-3 rounded-lg border border-gray-700 bg-[#262525] text-white focus:border-purple-500 focus:ring-purple-500 resize-none"
                                rows={3}
                            />
                        </div>
                        ...
                        <div className="flex justify-between items-center pt-4">
                            ...
                            <motion.button
                                ...
                                className={`px-8 py-3 rounded-lg font-semibold transition-all duration-200 ${isHalf && (!half1 || !half2)
