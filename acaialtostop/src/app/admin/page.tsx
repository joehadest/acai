                ...
                <div className="mb-6">
                    <div className="flex space-x-4">
                        <button
                            ...
                            className={`px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200 bg-transparent text-gray-200 hover:text-white ${activeTab === 'config' ? 'border-b-2 border-purple-600' : ''}`}
                        >
                            Configurações
                        </button>
                        <button
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200 bg-transparent text-gray-200 hover:text-white ${activeTab === 'pedidos' ? 'border-b-2 border-purple-600' : ''}`}
                        >
                            Pedidos
                        </button>
                    </div>
